    ...
    <aside id="side_bar" class=" d-md-block">
        <nav id="navmain" data-simplebar>
            <ul class="menu">
                <li class="user sub-menu pl-4 pt-2">
                    <div
                        ...
                        <div class="avatar mr-3 d-flex align-items-center">
                            <span class="circle d-flex align-items-center justify-content-center"> <?php echo e(Auth::user()->name[0]); ?> </span>
                        </div>
                        ...
                        <div id="userWrap" class="d-flex flex-column"
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span class="name-user d-lg-inline-block text-nav title-nav"> <?php echo e(Auth::user()->name); ?>! </span>
                            </div>
                        </div>
                    </div>
                    <ul class="sub-items">
                ...
                <li <?php if(Request::is('user')): ?> class="active" <?php endif; ?>><a href="/user/"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                            <use class="icon-svg" xlink:href="#inicio"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Inicio </span></a> </li>

                <li <?php if(Request::is('user/member/password')): ?> class="active" <?php endif; ?>><a href="/user/member/password"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                    <use class="icon-svg" xlink:href="#cuenta"></use>
                </svg> <span class=" text-nav d-md-inline-block"> Cambiar clave </span></a> </li>

                <li <?php if(Request::is('user/member/profile')): ?> class="active" <?php endif; ?>><a href="/user/member/profile"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                    <use class="icon-svg" xlink:href="#cuenta"></use>
                </svg> <span class=" text-nav d-md-inline-block"> Actualizar datos </span></a> </li>

                <li <?php if(Request::is('user/member/list')): ?> class="active" <?php endif; ?>><a href="/user/member/list"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                    <use class="icon-svg" xlink:href="#registro"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Solicitudes de Ingreso </span></a>
                </li>

                <li <?php if(Request::is('user/work/list')): ?> class="active" <?php endif; ?>><a href="/user/work/list"> <svg class="nav-icon mr-3" viewBox="0 0 512 640">
                            <use class="icon-svg" xlink:href="#registro"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Registro de Obras </span></a> </li>

                        <li <?php if(Request::is('user/jingles')): ?> class="active" <?php endif; ?>><a href="/user/jingles"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                            <use class="icon-svg" xlink:href="#registro"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Registro de Solicitud de Inclusión </span></a>
                </li>
            </ul>
            <div id="version">v<?php echo e(config('app.version')); ?></div>
        </nav>
    </aside>
</div>
...
<?php /**PATH /var/www/resources/views/user/layout/sidebar.blade.php ENDPATH**/ ?>