...
trait WorkDraftTrait {
    public function saveDraft($data)
    {
        ...
        if (data_get($data, 'registration_id', false)) {
            ...
            $registration->is_jingle = data_get($data, 'is_jingle', false);
            $registration->is_movie = data_get($data, 'is_movie', false);
            ...
            $registrationParams['is_jingle'] = data_get($data, 'is_jingle', false);
            $registrationParams['is_movie'] = data_get($data, 'is_movie', false);
